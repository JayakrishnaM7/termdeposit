...
public class CaptureLiquidityRequestLiquidity   {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CaptureLiquidityRequestLiquidity captureLiquidityRequestLiquidity = (CaptureLiquidityRequestLiquidity) o;
    return Objects.equals(this.enterpriseLargePaymentTransactionRecords, captureLiquidityRequestLiquidity.enterpriseLargePaymentTransactionRecords);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enterpriseLargePaymentTransactionRecords);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaptureLiquidityRequestLiquidity {\n");
