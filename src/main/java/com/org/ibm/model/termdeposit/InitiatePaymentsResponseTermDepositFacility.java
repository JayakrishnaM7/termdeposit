...
public class InitiatePaymentsResponseTermDepositFacility   {
  ...
  public InitiatePaymentsResponseTermDepositFacility taxReference(Object taxReference) {
  ...
  */
  ...
  public InitiatePaymentsResponseTermDepositFacility associationType(String associationType) {
  ...
  */
  ...
  public InitiatePaymentsResponseTermDepositFacility associationObligationOrEntitlement(String associationObligationOrEntitlement) {
  ...
  */
  ...
  public InitiatePaymentsResponseTermDepositFacility associationReference(Object associationReference) {
  ...
  */
  ...
  public InitiatePaymentsResponseTermDepositFacility positionLimitSettings(String positionLimitSettings) {
  ...
  */
  ...
  public InitiatePaymentsResponseTermDepositFacility dateType(String dateType) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InitiatePaymentsResponseTermDepositFacility initiatePaymentsResponseTermDepositFacility = (InitiatePaymentsResponseTermDepositFacility) o;
    return Objects.equals(this.taxReference, initiatePaymentsResponseTermDepositFacility.taxReference) &&
        Objects.equals(this.associationType, initiatePaymentsResponseTermDepositFacility.associationType) &&
        Objects.equals(this.associationObligationOrEntitlement, initiatePaymentsResponseTermDepositFacility.associationObligationOrEntitlement) &&
        Objects.equals(this.associationReference, initiatePaymentsResponseTermDepositFacility.associationReference) &&
        Objects.equals(this.positionLimitSettings, initiatePaymentsResponseTermDepositFacility.positionLimitSettings) &&
        Objects.equals(this.dateType, initiatePaymentsResponseTermDepositFacility.dateType);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiatePaymentsResponseTermDepositFacility {\n");
