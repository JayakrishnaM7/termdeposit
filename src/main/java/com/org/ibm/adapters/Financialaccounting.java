...
@Component
public class Financialaccounting implements JavaDelegate{
    ...
    private final static Logger LOGGER = Logger.getLogger(Financialaccounting.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Financialaccounting.class.getName());
         }else{
