...
@Component
public class Traderposition implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private TraderpositionmanagementRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Traderposition.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Traderposition.class.getName());
         }else{
