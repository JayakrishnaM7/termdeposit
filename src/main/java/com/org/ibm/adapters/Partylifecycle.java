...
@Component
public class Partylifecycle implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private PartylifecycleRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Partylifecycle.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Partylifecycle.class.getName());
         }else{
