...
@Component
public class Customerproductandservice implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CustomerproductandserviceRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Customerproductandservice.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Customerproductandservice.class.getName());
         }else{
