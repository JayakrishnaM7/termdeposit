...
@Component
public class Transactionauthorisation implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private TransactionauthorisationRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Transactionauthorisation.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Transactionauthorisation.class.getName());
         }else{
