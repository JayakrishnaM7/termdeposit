...
@Component
public class Serviceorder implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private ServiceorderRestProcessor restProcessor;
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Serviceorder.class.getName());
         }else{
